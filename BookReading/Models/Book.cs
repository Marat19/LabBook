...
namespace BookReading.Models
{
    ...
    { 
        ...
        [Display(Name = "Описаие"), LinqToDB.Mapping.Column]
        public string Description { get; set; }

        [Display(Name = "Автор"), LinqToDB.Mapping.Column]
        public string Author { get; set; }

        [Display(Name = "Страницы"), LinqToDB.Mapping.Column]
        public int Pages { get; set; }

        [Display(Name = "Жанр"), LinqToDB.Mapping.Column]
